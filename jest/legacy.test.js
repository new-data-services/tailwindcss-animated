...
describe('legacy tailwind', () => {
    it('generates `composition` utilities', async () => {
        expect(await run('content/composition.html')).toContainAll([
    ...
    it('should add `delay` utilities', async () => {
        expect(await run('content/delay.html')).toContainAll([
    ...
    it('generates `direction` utilities', async () => {
        expect(await run('content/direction.html')).toContainAll([
    ...
    it('generates `duration` utilities', async () => {
        expect(await run('content/duration.html')).toContainAll([
    ...
    it('generates `fill-mode` utilities', async () => {
        expect(await run('content/fill-mode.html')).toContainAll([
    ...
    it('generates `iteration-count` utilities', async () => {
        expect(await run('content/iteration-count.html')).toContainAll([
    ...
    it('generates `play-state` utilities', async () => {
        expect(await run('content/play-state.html')).toContainAll([
    ...
    it('generates `timing-function` utilities', async () => {
        expect(await run('content/timing-function.html')).toContainAll([
    ...
    it('generates predefined animations', async () => {
        const css = await run('content/predefined-animations.html')
